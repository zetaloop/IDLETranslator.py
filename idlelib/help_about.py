...
class AboutDialog(Toplevel):
    ...
    def __init__(self, parent, title=None, *, _htest=False, _utest=False):
        ...
        self.title(title or
                   f'关于 IDLE {python_version()} ({build_bits()} bit)')
    ...
    def create_widgets(self):
        ...
        byline_text = "Python 的集成开发和学习环境" + 5*'\n'
        byline = Label(frame_background, text=byline_text, justify=LEFT,
                       fg=self.fg, bg=self.bg)
        byline.grid(row=2, column=0, sticky=W, columnspan=3, padx=10, pady=5)
        email = Label(frame_background, text='电子邮箱:  idle-dev@python.org',
        ...
        self.py_license = Button(py_buttons, text='许可', width=8,
        ...
        self.py_credits = Button(py_buttons, text='致谢', width=8,
                                 highlightbackground=self.bg,
        ...
        self.readme = Button(idle_buttons, text='简介', width=8,
                             highlightbackground=self.bg,
                             command=self.show_readme)
        self.readme.pack(side=LEFT, padx=10, pady=10)
        self.idle_news = Button(idle_buttons, text='更新', width=8,
                                highlightbackground=self.bg,
                                command=self.show_idle_news)
        self.idle_news.pack(side=LEFT, padx=10, pady=10)
        self.idle_credits = Button(idle_buttons, text='致谢', width=8,
                                   highlightbackground=self.bg,
    ...
    def show_py_credits(self):
        ...
        self.display_printer_text('关于 - Python 的支持者', credits)

    # Encode CREDITS.txt to utf-8 for proper version of Loewis.
    # Specify others as ascii until need utf-8, so catch errors.
    def show_idle_credits(self):
        "Handle Idle Credits button event."
        self.display_file_text('关于 - 支持者', 'CREDITS.txt', 'utf-8')

    def show_readme(self):
        "Handle Readme button event."
        self.display_file_text('关于 - 简介', 'README.txt', 'ascii')

    def show_idle_news(self):
        "Handle News button event."
        self.display_file_text('关于 - 更新内容', 'NEWS.txt', 'utf-8')
